...
(function () {
  ...
  function hubEnsure() {
    ...
    btn.onclick = function (e) { e.stopPropagation(); show(menu.style.display !== 'block'); };
    ...
    // Ẩn gear riêng của từng tool
    setTimeout(function () {
      ['as-l4m-btn', 'as-gt-btn', 'as2s-btn'].forEach(function (id) {
        var el = document.getElementById(id);
        if (el) el.style.display = 'none';
      });
    }, 2000);
